...
SUCCESS_OUTCOMES = {"won", "success", "success in play", "success out", "successful", "complete"}  # amplía si lo necesitas
...
def is_success(ev) -> bool:
    ...
    if t == "ball recovery":
        return not bool(ev.get("ball_recovery_failure"))
    
    if t == "ball receipt":
        return _outcome_of(ev) != "incomplete"
